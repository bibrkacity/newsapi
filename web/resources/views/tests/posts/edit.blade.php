...
<head>
    ...
    <script type="text/javascript">
        ...
        function send_request()
        {
            ...
            let fields = ['api_token','id','language_id','title','description','content','tags'];
            ...
            let curl_string = 'curl -X "PATCH" -d "'+data_string+'" '+document.location.protocol+'//'+document.location.host+curl_url;
